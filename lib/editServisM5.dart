...
class editServisM5 extends StatelessWidget {
  final ActifSiparis actifSiparis;
  editServisM5({required this.actifSiparis}) ;
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: editYasliInfoScreen(actifSiparis: actifSiparis,),
    );
  }
}

class editYasliInfoScreen extends StatefulWidget {
  final ActifSiparis actifSiparis;
  editYasliInfoScreen({required this.actifSiparis}) ;
  @override
  _editYasliInfoScreenState createState() => _editYasliInfoScreenState(actifSiparis: actifSiparis);
}

class _editYasliInfoScreenState extends State<editYasliInfoScreen> {

  final ActifSiparis actifSiparis;
  _editYasliInfoScreenState({required this.actifSiparis}) : tc = '';
