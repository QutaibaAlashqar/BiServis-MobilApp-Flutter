...
class ServicsM2 extends StatelessWidget {
  final String s_id;
  ServicsM2({required this.s_id});
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: ServicsM2Page(s_id: s_id,),
    );
  }
}

class ServicsM2Page extends StatefulWidget {
  final String s_id;
  ServicsM2Page({required this.s_id});
  @override
  _ServicsM2PageState createState() => _ServicsM2PageState(s_id: s_id);
}

class _ServicsM2PageState extends State<ServicsM2Page> {
  final String s_id;
  _ServicsM2PageState({required this.s_id}) : tc = '';
