...
class faturaServisM5 extends StatelessWidget {
  final GecmisSiparis actifSiparis;
  final int from;
  faturaServisM5({required this.actifSiparis,required this.from});
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: faturaServisM5Screen(actifSiparis: actifSiparis,from: from),
    );
  }
}

class faturaServisM5Screen extends StatefulWidget {
  final GecmisSiparis actifSiparis;
  final int from;
  faturaServisM5Screen({required this.actifSiparis,required this.from});
  @override
  _faturaServisM5ScreenState createState() => _faturaServisM5ScreenState(actifSiparis: actifSiparis,from: from);
}

class _faturaServisM5ScreenState extends State<faturaServisM5Screen> {
  final int from;
  final GecmisSiparis actifSiparis;
  _faturaServisM5ScreenState({required this.actifSiparis,required this.from});
