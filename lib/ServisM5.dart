...
class ServisM5 extends StatelessWidget {
  final String s_id;
  ServisM5({required this.s_id}) ;
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: YasliInfoScreen(s_id: s_id,),
    );
  }
}

class YasliInfoScreen extends StatefulWidget {
  final String s_id;
  YasliInfoScreen({required this.s_id}) ;
  @override
  _YasliInfoScreenState createState() => _YasliInfoScreenState(s_id: s_id);
}

class _YasliInfoScreenState extends State<YasliInfoScreen> {

  final String s_id;
  _YasliInfoScreenState({required this.s_id}) : tc = '';
