...
class detailServisM4 extends StatelessWidget {
  final Orders actifSiparis;
  detailServisM4({required this.actifSiparis}) ;
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: detailServisM4Screen(actifSiparis: actifSiparis,),
    );
  }
}

class detailServisM4Screen extends StatefulWidget {
  final Orders actifSiparis;
  detailServisM4Screen({required this.actifSiparis}) ;
  @override
  _detailServisM4ScreenState createState() => _detailServisM4ScreenState(actifSiparis: actifSiparis);
}

class _detailServisM4ScreenState extends State<detailServisM4Screen> {

  final Orders actifSiparis;
  _detailServisM4ScreenState({required this.actifSiparis});
